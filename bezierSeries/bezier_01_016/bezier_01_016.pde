...
void draw(){
  ...
  a  = new PVector(random(width),random(height));//((Draggable)d.get(0));
  b  = new PVector(random(width),random(height));//((Draggable)d.get(1));
  c1 = new PVector(random(width),random(height));//((Draggable)d.get(2));
  c2 = new PVector(random(width),random(height));//((Draggable)d.get(3));
