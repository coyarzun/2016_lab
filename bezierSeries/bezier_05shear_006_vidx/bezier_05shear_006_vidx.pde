...
void setup() {
  size(479,270);//1920, 1080);//displayWidth, displayHeight);
  ...
  video = new Movie(this, "/Users/coyarzun/ima/recreative/porn/mandyMorbid/Hospital_Mandy Morbid_part1 - Pornhub.com.mp4");
  //epic.mp4");
  video.loop();
