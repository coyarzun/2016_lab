...
void setup(){
  ...
  d.add( new Draggable(10,height-10) );
...
void draw(){
  ...
  PVector m1, m2,m3;
  m1 = new PVector( (a.x+c.x)/2.0, (a.y+c.y)/2.0 ); 
  m2 = new PVector( (b.x+c.x)/2.0, (b.y+c.y)/2.0 );
  m3 = new PVector( (m1.x+m2.x)/2.0, (m1.y+m2.y)/2.0 );
