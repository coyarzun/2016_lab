...
void setup() {
  cfn = 0;
  img = loadImage("../_data/68944.png");//wiros_400x400.jpg");
...
void record(){
  saveFrame("../_xrenders/_animated/"+filename[cfn]+"/"+filename[cfn]+"_####.png");
...
void keyPressed(){
  ...
  if(key=='s'){
    saveFrame("../_xrenders/_stills/"+filename[cfn]+"_####.png");
    println("still saved");
  }
}
