...
PImage img, mandy;// = loadImage("mandy_800x400.jpg");
Movie video;



void setup() {
  size(512*2, 256*2, P3D);
  ...
  //video = new Movie(this, "/Users/coyarzun/ima/recreative/porn/4jPorn/IMG_4692.mp4");//
  ...
  //video = new Movie(this, "/Users/coyarzun/ima/recreative/porn/1 Minute QUICKIE CHALLENGE (PMV KPOP + AIKA HONDA) - Pornhub.MP4");
  //video = new Movie(this, "/Users/coyarzun/ima/recreative/porn/Stunning Cuban Flag Body Painting - Pornhub.com.mp4");
  //video = new Movie(this, "/Users/coyarzun/ima/recreative/porn/Cumshot Compilation of Amateur Nikki Wolfe - Pornhub.com.mp4");
  video.loop();
  //video.speed(0.5);
}
