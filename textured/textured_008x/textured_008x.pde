...
void draw(){
  ...
  for(int i=0; i<cols; i++){
    for(int j=0; j<rows; j++){
      ...
      float radioMenorsss = radioMenor*cos(0.25*i*da);//frameCount*0.0125//frameCount*0.0125
      float radioMenorsss2 = radioMenor*cos(0.25*(i+1)*da);//frameCount*0.0125//frameCount*0.0125
      float t = i*da;
