class Snake{
  ...
  void move(){
    if(todirecion==2 && (body.get(0).direction==1 || body.get(0).direction==3) ){
      body.get(0).direction=2;
    }else if(todirecion==0 && (body.get(0).direction==1 || body.get(0).direction==3) ){
      body.get(0).direction=0;
    }else if(todirecion==2 && (body.get(0).direction==0 || body.get(0).direction==2) ){
      body.get(0).direction=3;
    }else if(todirecion==1 && (body.get(0).direction==0 || body.get(0).direction==2) ){
